...
import com.chakra.shoppinglist.model.TopProductsInfo
...
class TopProductListFragment : BaseFragment() {
    private val viewModelTop: TopProductsViewModel by viewModel()
    ...
    override fun initialize() {
        ...
        viewModelTop.productsLiveData.observe(viewLifecycleOwner) { topProducts ->
            topProducts?.let {
                if (it.topProductBucket.isNullOrEmpty()) {
    ...
    inner class ProductsAdapter : RecyclerView.Adapter<ViewHolder>() {
        ...
        private var productList: List<TopProductsInfo>? = null

        fun setList(list: ShoppingPlanTypeWithTopProducts) {
            this.productList = list.topProductBucket
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(position: Int, product: TopProductsInfo, imageLoader: RequestManager) {
